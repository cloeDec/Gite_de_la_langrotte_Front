        ...
        <div className="App">
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route
                path={"/admin"}
                element={isAuthenticated ? <Admin /> : <HomePage />}
              />
              <Route
                path={"/adminclient"}
                element={isAuthenticated ? <AdminClient /> : <HomePage />}
              />
              <Route
                path={"/adminreservation"}
                element={isAuthenticated ? <AdminReservation /> : <HomePage />}
              />
              <Route
                path={"/admin/:id"}
                element={isAuthenticated ? <ModifGite /> : <HomePage />}
              />
              <Route
                path={"/utilisateur/:id"}
                element={isAuthenticated ? <AdminProfil /> : <HomePage />}
              />
            </Routes>
